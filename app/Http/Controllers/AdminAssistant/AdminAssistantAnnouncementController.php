...
class AdminAssistantAnnouncementController extends AdminAssistantBaseController
{
    ...
    public function storeAnnouncement(Request $request): JsonResponse
    {
        ...
        $this->logActivity((int) $request->user()->user_id, 'ANNOUNCE', sprintf('Posted announcement "%s".', $validated['title']));
    ...
    public function destroyAnnouncement(Request $request, int $announcementId): JsonResponse
    {
        ...
        $this->logActivity((int) $request->user()->user_id, 'ANNOUNCE', sprintf('Deleted announcement "%s".', $announcement->title));
