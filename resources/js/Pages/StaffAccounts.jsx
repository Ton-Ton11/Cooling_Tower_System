...
function StaffAccounts({ addToast, onDataChanged }) {
        ...
        try {
            const response = editTarget
                ? await window.axios.patch(
                      SUPER_ADMIN_ENDPOINTS.updateStaff(editTarget.user_id),
                      payload,
                  )
                : await window.axios.post(SUPER_ADMIN_ENDPOINTS.staff, payload);
    ...
    const handleArchive = async () => {
        ...
        try {
            const { data } = await window.axios.patch(
                SUPER_ADMIN_ENDPOINTS.archiveStaff(archiveTarget.user_id),
            );
    ...
    const handleRestore = async () => {
        ...
        try {
            const { data } = await window.axios.patch(
                SUPER_ADMIN_ENDPOINTS.restoreStaff(restoreTarget.user_id),
            );
