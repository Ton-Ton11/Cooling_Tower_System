...
const navItems = [
  ...
  { id: "bookings", label: "Bookings", icon: ic.bookings, badge: 12 },
  ...
  { id: "announcements", label: "Announcements", icon: ic.announcements, badge: 3 },
...
function Sidebar({
  ...
  const sidebarStyle = isMobile
    ? {
        ...
        top: 0,
        left: 0,
        background: "linear-gradient(180deg,#1E2F5F 0%,#162347 60%,#0E1932 100%)",
        display: "flex",
    ...
    <aside style={sidebarStyle}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, overflow: "hidden" }}>
          ...
          {(!collapsed || isMobile) && (
            <div style={{ overflow: "hidden" }}>
              <p style={{ fontSize: 12, fontWeight: 700, color: "#fff", whiteSpace: "nowrap", lineHeight: 1.2, margin: 0 }}>
                Cooling Tower
              </p>
              <p style={{ fontSize: 10, color: "#59B7FF", fontWeight: 500, whiteSpace: "nowrap", lineHeight: 1.3, margin: 0 }}>
          ...
          return (
            <button
              ...
              style={{
                ...
                borderRadius: 12,
                border: "none",
                background: isActive ? "rgba(63,125,255,0.25)" : "transparent",
                cursor: "pointer",
            ...
            >
              ...
              {(!collapsed || isMobile) && (
                <span style={{ fontSize: 13, fontWeight: isActive ? 600 : 500, flex: 1, textAlign: "left", whiteSpace: "nowrap" }}>
                  {item.label}
                </span>
              )}
      ...
      <div style={{ padding: "10px 8px", borderTop: "1px solid rgba(255,255,255,0.08)", flexShrink: 0 }}>
        ...
        >
          ...
          {(!collapsed || isMobile) && (
            <span style={{ fontSize: 13, fontWeight: 500, whiteSpace: "nowrap" }}>Logout</span>
          )}
        </button>
      </div>
    </aside>
